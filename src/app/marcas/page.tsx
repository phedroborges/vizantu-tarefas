...
export default async function BrandsPage() {
  ...
  return <AdminShell active="marcas" user={user}><BrandsView initialBrands={brands} initialProjects={visibleProjects} taskCounts={Object.fromEntries(taskEntries)} canEdit={podePlanejar(user.role)} /></AdminShell>;
}
